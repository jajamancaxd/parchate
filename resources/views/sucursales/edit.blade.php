...
<body>
    ...
    <form action="{{ route('sucursales.update', $sucursal->id_sucursal) }}" method="POST" enctype="multipart/form-data" id="formEditarSucursal">
        @csrf
        @method('PUT')
    ...
    <script>
        ...
        document.getElementById('formEditarSucursal').addEventListener('submit', function () {
